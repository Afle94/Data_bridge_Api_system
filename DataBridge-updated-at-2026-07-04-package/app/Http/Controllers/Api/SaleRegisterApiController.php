...
class SaleRegisterApiController extends Controller
{
    public function store(Request $request): JsonResponse
    {
        ...
        $existingVoucherNumbers = SaleRegister::query()
            ...
            ->mapWithKeys(fn (SaleRegister $sale): array => [$this->voucherDuplicateKey($sale->getAttributes()) => true])
            ->all();
    ...
    private function normalize(array $record): array
    {
        ...
        return [
            'user_code' => $this->value($record, ['user_code', 'usercode', 'UserCode', 'User Code', 'use_code', 'UseCode', 'Use Code', 'usr_code', 'UsrCode', 'USR_CODE', 'ucode', 'UCode']),
