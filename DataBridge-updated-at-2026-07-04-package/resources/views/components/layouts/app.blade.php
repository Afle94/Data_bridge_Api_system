    ...
    <div class="app-shell" data-sidebar-shell>
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav" aria-label="Main navigation">
                ...
                <a href="{{ route('purchases.register') }}" class="nav-link {{ request()->routeIs('purchases.*') ? 'active' : '' }}">
                    <span class="nav-icon">P</span>
                    <span class="nav-label">Purchase Register</span>
                </a>
                <a href="{{ route('receipts.register') }}" class="nav-link {{ request()->routeIs('receipts.*') ? 'active' : '' }}">
                    <span class="nav-icon">R</span>
                    <span class="nav-label">Receipt Register</span>
                </a>
                <a href="{{ route('payments.register') }}" class="nav-link {{ request()->routeIs('payments.*') ? 'active' : '' }}">
                    <span class="nav-icon">P</span>
                    <span class="nav-label">Payment Register</span>
                </a>
            </nav>
        </aside>
