...
class SaleRegisterController extends Controller
{
    ...
    private function xlsxWorksheet($sales, array $totals, string $search): string
    {
        ...
        $headers = [
            'Invoice No.', 'Tran Date', 'Rec Date', 'Party Name', 'Add1', 'City', 'State',
        ...
        $rows[] = $this->xlsxRow($rowNumber + 1, [
            ['Grand Total', 's', 5], ['', 's', 5], ['', 's', 5], ['', 's', 5], ['', 's', 5], ['', 's', 5], ['', 's', 5],
        ...
        return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'
            ...
            . '<cols>'
            . '<col min="1" max="1" width="13" customWidth="1"/><col min="2" max="3" width="12" customWidth="1"/>'
            . '<col min="4" max="5" width="34" customWidth="1"/><col min="6" max="7" width="18" customWidth="1"/>'
            . '<col min="8" max="14" width="14" customWidth="1"/><col min="15" max="15" width="32" customWidth="1"/>'
            . '</cols><sheetData>' . implode('', $rows) . '</sheetData>'
            . '<mergeCells count="10"><mergeCell ref="A1:O1"/><mergeCell ref="A2:O2"/><mergeCell ref="A4:B4"/><mergeCell ref="C4:D4"/><mergeCell ref="E4:F4"/><mergeCell ref="G4:H4"/><mergeCell ref="I4:J4"/><mergeCell ref="K4:L4"/><mergeCell ref="M4:O4"/><mergeCell ref="A' . $mergeRow . ':G' . $mergeRow . '"/></mergeCells>'
            . '</worksheet>';
    }
